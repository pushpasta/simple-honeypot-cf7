			...
			<tr>
				...
				<td>
					<?php if ( ! $form['time_mode_custom'] ) : ?>
						...
						printf( esc_html__( 'Uses global (%s)', 'simple-honeypot-cf7' ), esc_html( 'enabled' === $form['resolved_mode'] ? __( 'Enabled', 'default' ) : __( 'Disabled', 'default' ) ) );
						?>
					</span>
				<?php elseif ( 'enabled' === $form['time_mode'] ) : ?>
					<span class="simple-honeypot-cf7-badge simple-honeypot-cf7-badge--active"><?php esc_html_e( 'Enabled', 'default' ); ?></span>
				<?php else : ?>
					<span class="simple-honeypot-cf7-badge simple-honeypot-cf7-badge--inactive"><?php esc_html_e( 'Disabled', 'default' ); ?></span>
					<?php endif; ?>
				</td>
				<td>
