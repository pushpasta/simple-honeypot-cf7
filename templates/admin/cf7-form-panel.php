...
<div class="simple-honeypot-cf7-form-panel-box">
	<table class="form-table" role="presentation">
		<tr>
			<th scope="row"><label for="simple_honeypot_cf7_form_time_mode"><?php esc_html_e( 'Timing check', 'simple-honeypot-cf7' ); ?></label></th>
			<td>
				<select id="simple_honeypot_cf7_form_time_mode" name="simple_honeypot_cf7_form[time_mode]">
